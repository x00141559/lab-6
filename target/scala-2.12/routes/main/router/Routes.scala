...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """shouldCancel""", """controllers.ShoppingCtrl.shouldCancel()"""),
    Nil
  ...
  // @LINE:43
  private[this] lazy val controllers_ShoppingCtrl_shouldCancel23_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("shouldCancel")))
  )
  private[this] lazy val controllers_ShoppingCtrl_shouldCancel23_invoker = createInvoker(
    ShoppingCtrl_1.shouldCancel(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.ShoppingCtrl",
      "shouldCancel",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:43
    case controllers_ShoppingCtrl_shouldCancel23_route(params@_) =>
      call { 
        controllers_ShoppingCtrl_shouldCancel23_invoker.call(ShoppingCtrl_1.shouldCancel())
      }
  }
}
